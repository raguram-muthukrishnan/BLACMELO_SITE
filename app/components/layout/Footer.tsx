        ...
        <div className="footer-desktop">
          ...
          <div className="footer-section">
            ...
            <div className="footer-links">
              ...
              <p className="footer-support-hours" style={{ fontSize: '14px', fontWeight: 'normal' }}>Available Sun–Thu, 9am–6pm GST</p>
            </div>
          </div>
          ...
          <div className="footer-section footer-newsletter">
            ...
            <div className="footer-social">
              ...
              <a href="https://wa.me/971525648367" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
            ...
            <div className="footer-mobile-section">
              ...
              {openSections.social && (
                <div className="footer-mobile-links">
                  ...
                  <a href="tel:+971525648367">UAE +971 52 5648367</a>
                  <p className="footer-support-hours" style={{ fontSize: '14px', fontWeight: 'normal' }}>Available Sun–Thu, 9am–6pm GST</p>
                  <a href="https://wa.me/971525648367" target="_blank" rel="noopener noreferrer">WhatsApp</a>
