...
export type MoneyProductItemClubFragment = Pick<
  StorefrontAPI.MoneyV2,
  'amount' | 'currencyCode'
>;

export type ProductItemClubFragment = Pick<
  StorefrontAPI.Product,
...
export type BlacmeloClubCollectionQueryVariables = StorefrontAPI.Exact<{
...
export type BlacmeloClubCollectionQuery = {
...
export type ShopContactQuery = {shop: Pick<StorefrontAPI.Shop, 'name'>};
...
export type MoneyProductItemPrivateFragment = Pick<
  StorefrontAPI.MoneyV2,
  'amount' | 'currencyCode'
>;

export type ProductItemPrivateFragment = Pick<
  StorefrontAPI.Product,
  'id' | 'handle' | 'title' | 'productType' | 'vendor'
> & {
  featuredImage?: StorefrontAPI.Maybe<
...
export type PrivateCollectionQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
  first?: StorefrontAPI.InputMaybe<StorefrontAPI.Scalars['Int']['input']>;
...
export type PrivateCollectionQuery = {
  collection?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Collection, 'id' | 'handle' | 'title'> & {
      products: {
        nodes: Array<
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  #graphql\n  fragment MoneyProductItemPrivate on MoneyV2 {\n    amount\n    currencyCode\n  }\n  fragment ProductItemPrivate on Product {\n    id\n    handle\n    title\n    productType\n    vendor\n    featuredImage {\n      id\n      altText\n      url\n      width\n      height\n    }\n    images(first: 2) {\n      nodes {\n        id\n        altText\n        url\n        width\n        height\n      }\n    }\n    variants(first: 100) {\n      nodes {\n        id\n        availableForSale\n        selectedOptions {\n          name\n          value\n        }\n      }\n    }\n    priceRange {\n      minVariantPrice {\n        ...MoneyProductItemPrivate\n      }\n      maxVariantPrice {\n        ...MoneyProductItemPrivate\n      }\n    }\n    metafields(\n      identifiers: [\n        {namespace: "custom", key: "color_name"}\n        {namespace: "custom", key: "color"}\n        {namespace: "category", key: "color"}\n        {namespace: "category", key: "Color"}\n      ]\n    ) {\n      key\n      value\n      namespace\n    }\n  }\n\n  query BlacmeloClubCollection(\n    $handle: String!\n    $country: CountryCode\n    $language: LanguageCode\n    $first: Int\n    $last: Int\n    $startCursor: String\n    $endCursor: String\n  ) @inContext(country: $country, language: $language) {\n    collection(handle: $handle) {\n      id\n      handle\n      title\n      products(\n        first: $first,\n        last: $last,\n        before: $startCursor,\n        after: $endCursor\n      ) {\n        nodes {\n          ...ProductItemClub\n        }\n        pageInfo {\n          hasPreviousPage\n          hasNextPage\n          endCursor\n          startCursor\n        }\n      }\n    }\n  }\n': {
    return: BlacmeloClubCollectionQuery;
    variables: BlacmeloClubCollectionQueryVariables;
  };
  ...
  '#graphql\n  #graphql\n  fragment MoneyProductItemPrivate on MoneyV2 {\n    amount\n    currencyCode\n  }\n  fragment ProductItemPrivate on Product {\n    id\n    handle\n    title\n    productType\n    vendor\n    featuredImage {\n      id\n      altText\n      url\n      width\n      height\n    }\n    images(first: 2) {\n      nodes {\n        id\n        altText\n        url\n        width\n        height\n      }\n    }\n    variants(first: 100) {\n      nodes {\n        id\n        availableForSale\n        selectedOptions {\n          name\n          value\n        }\n      }\n    }\n    priceRange {\n      minVariantPrice {\n        ...MoneyProductItemPrivate\n      }\n      maxVariantPrice {\n        ...MoneyProductItemPrivate\n      }\n    }\n    metafields(\n      identifiers: [\n        {namespace: "custom", key: "color_name"}\n        {namespace: "custom", key: "color"}\n        {namespace: "category", key: "color"}\n        {namespace: "category", key: "Color"}\n      ]\n    ) {\n      key\n      value\n      namespace\n    }\n  }\n\n  query PrivateCollection(\n    $handle: String!\n    $country: CountryCode\n    $language: LanguageCode\n    $first: Int\n    $last: Int\n    $startCursor: String\n    $endCursor: String\n  ) @inContext(country: $country, language: $language) {\n    collection(handle: $handle) {\n      id\n      handle\n      title\n      products(\n        first: $first,\n        last: $last,\n        before: $startCursor,\n        after: $endCursor\n      ) {\n        nodes {\n          ...ProductItemPrivate\n        }\n        pageInfo {\n          hasPreviousPage\n          hasNextPage\n          endCursor\n          startCursor\n        }\n      }\n    }\n  }\n': {
    return: PrivateCollectionQuery;
    variables: PrivateCollectionQueryVariables;
  };
